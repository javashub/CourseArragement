...
//    void insertCoursePlan(CoursePlan coursePlan);
    ...
    @Insert("insert into tb_course_plan(grade_no, class_no, course_no, teacher_no, classroom_no, class_time) values(#{grade_no}, #{class_no}, #{course_no}, #{teacher_no}, #{classroom_no}, #{class_time})")
    void insertCoursePlan(@Param("grade_no") String grade_no, @Param("class_no") String class_no, @Param("course_no") String course_no,
                          @Param("teacher_no") String teacher_no, @Param("classroom_no") String classroom_no, @Param("class_time") String class_time);
}
