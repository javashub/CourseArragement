        ...
        return List.of(
                ...
                MenuTreeVO.builder()
                        ...
                        .children(List.of(
                                MenuTreeVO.builder()
                                        .id(41L)
                                        .menuCode("base-teacher")
                                        .parentId(4L)
                                        .menuName("教师管理")
                                        .menuType("MENU")
                                        .routeName("TeacherManagePage")
                                        .routePath("/base-data/teachers")
                                        .componentPath("views/base/BaseDataView.vue")
                                        .icon("User")
                                        .permissionCode("page:teacher:view")
                                        .isHidden(0)
                                        .isKeepAlive(0)
                                        .sortNo(1)
                                        .children(List.of())
                                ...
                                MenuTreeVO.builder()
                                        .id(42L)
                                        .menuCode("base-student")
                                        .parentId(4L)
                                        .menuName("学生管理")
                                        .menuType("MENU")
                                        .routeName("StudentManagePage")
                                        .routePath("/base-data/students")
                                        .componentPath("views/base/BaseDataView.vue")
                                        .icon("UserFilled")
                                        .permissionCode("page:student:view")
                                        .isHidden(0)
                                        .isKeepAlive(0)
                                        .sortNo(2)
                                        .children(List.of())
                                ...
                                MenuTreeVO.builder()
                                        .id(43L)
                                        .menuCode("base-course")
                                        .parentId(4L)
                                        .menuName("课程管理")
                                        .menuType("MENU")
                                        .routeName("CourseManagePage")
                                        .routePath("/base-data/courses")
                                        .componentPath("views/base/BaseDataView.vue")
                                        .icon("Reading")
                                        .permissionCode("page:course:view")
                                        .isHidden(0)
                                        .isKeepAlive(0)
                                        .sortNo(3)
                                        .children(List.of())
                                ...
                                MenuTreeVO.builder()
                                        .id(44L)
                                        .menuCode("base-classroom")
                                        .parentId(4L)
                                        .menuName("教室管理")
                                        .menuType("MENU")
                                        .routeName("ClassroomManagePage")
                                        .routePath("/base-data/classrooms")
                                        .componentPath("views/base/BaseDataView.vue")
                                        .icon("OfficeBuilding")
                                        .permissionCode("page:classroom:view")
                                        .isHidden(0)
                                        .isKeepAlive(0)
                                        .sortNo(4)
                                        .children(List.of())
